            ...
            <div class="row">
               <div class="col-xxl-5 col-lg-5 col-md-7">
                  <div class="mb-7 mb-xl-0">
                     <div class="mb-4 ">
                        <a href="#">
                           <img src="assets/images/logo/logo.svg" alt="logo" class="" />
                        </a>
                     </div>
                     <p class="mb-5">Teman Perjalanan  Finansialmu!</p>
            ...
            <div class="row align-items-center">
               <div class="col-md-9">
                  <div class="small mb-3 mb-md-0">
                     ...
                     <span class="text-primary"><a href="#">Asimetrics Finance Game</a></span>
